...
function (_Component) {
  ...
  _createClass(Register, [{
    ...
    value: function render() {
      ...
      if (account.status === _index.Constants.ACCOUNT_STATUS.LOGGED_IN) {
      ...
      } else if (account.status === _index.Constants.ACCOUNT_STATUS.LOGGED_OUT) {
        ...
        return _react.default.createElement("div", null, _react.default.createElement("section", {
          ...
          titleText: "Register"
        })), _react.default.createElement("section", null, _react.default.createElement(_ui.Forms.Register, this.props)));
      }
    }
  }]);
