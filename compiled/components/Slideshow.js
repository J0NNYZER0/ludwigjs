...
function (_Component) {
  ...
  _createClass(Slideshow, [{
    key: "slide",
    value: function slide(ct, i) {
      var idx = this.state.idx,
          _this$props$progress = this.props.progress,
          progress = _this$props$progress === void 0 ? function () {} : _this$props$progress;
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "ss-btn lft arrow l",
        onClick: function onClick() {
          _this2.slide(children.length, idx - 1);
        }
      }), _react.default.createElement("div", {
        className: "ss-btn rt arrow",
        onClick: function onClick() {
          _this2.slide(children.length, idx + 1);
        }
      }));
